...
rec {
  ...
  workspaceMembers = {
    "reconnecting-amqp" = rec {
      packageId = "reconnecting-amqp";
    ...
    "tulpje-framework" = rec {
      packageId = "tulpje-framework";
      build = internal.buildRustCrateWithFeatures {
        packageId = "tulpje-framework";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "amqp_serde" = rec {
        crateName = "amqp_serde";
        version = "0.4.2";
        edition = "2021";
        sha256 = "10bpaawixy00bbq0k64d8xzg13qbbnz9hmr32rj916w4lh6l7bs6";
        dependencies = [
          {
            name = "bytes";
            packageId = "bytes";
      ...
      "amqprs" = rec {
        ...
        version = "2.1.2";
        edition = "2021";
        sha256 = "0dkpacxdrj5fxxpf8dmhmqqvxsj1kpp45m06n0sdx3zsnck91sq9";
        dependencies = [
          {
            name = "amqp_serde";
            packageId = "amqp_serde";
          }
          {
            name = "async-trait";
        ...
        features = {
          ...
          "tls" = [ "tokio-rustls" "rustls-pemfile" "webpki-roots" "rustls-pki-types" "rustls-webpki" ];
          "tokio-rustls" = [ "dep:tokio-rustls" ];
          "traces" = [ "tracing" ];
          "tracing" = [ "dep:tracing" ];
          "uriparse" = [ "dep:uriparse" ];
          "urispec" = [ "uriparse" ];
          "webpki-roots" = [ "dep:webpki-roots" ];
        };
        resolvedDefaultFeatures = [ "compliance_assert" "default" "traces" "tracing" "uriparse" "urispec" ];
      };
      ...
      "async-cron-scheduler" = rec {
        crateName = "async-cron-scheduler";
        version = "2.0.1";
        edition = "2021";
        sha256 = "0n7bvgi1g7dx6gqqq1iw41cz1s2x69rawycsqwsyq2z4007slkqh";
        libName = "async_cron_scheduler";
        authors = [
      ...
      "async-event" = rec {
        crateName = "async-event";
        version = "0.1.0";
        edition = "2021";
        sha256 = "1nxv4lvh0yk26ya21s9951gmalx36lz75rbbc108ddpzlxfmjwj1";
        libName = "async_event";
        authors = [
          "Serge Barral <serge.barral@asynchronics.com>"
        ];
        dependencies = [
          {
            name = "loom";
            packageId = "loom";
            target = { target, features }: (target."async_event_loom" or false);
          }
        ];
      ...
      "cron" = rec {
        ...
        version = "0.12.1";
        edition = "2021";
        sha256 = "01qc1cnhibxh55pwv3mwaxvfgbjpgk1lfl7an5m4ljvv0xrkx33g";
        authors = [
      ...
      "diatomic-waker" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        sha256 = "1s9511f7lv0icp96xv3f0drz6m3j8dgmaxq8gg7mm0cxbasmy0i8";
        ...
        dependencies = [
          {
            name = "loom";
            packageId = "loom";
            target = { target, features }: (target."diatomic_waker_loom" or false);
          }
          {
            name = "waker-fn";
            packageId = "waker-fn";
      ...
      "figment_file_provider_adapter" = rec {
        crateName = "figment_file_provider_adapter";
        version = "0.1.1";
        edition = "2021";
        sha256 = "0553h2yf5nlyhnhkywscmzaq8wih1njhi51h50vzlzkrjq41wgim";
        authors = [
          "nitnelave <valentin@tolmer.fr>"
        ];
        dependencies = [
          {
            name = "figment";
      ...
      "libproc" = rec {
        ...
        version = "0.14.10";
        edition = "2018";
        sha256 = "1yzbhywjzvhi4353pni6k8jbpildd1qp66d1banvrbg5dfshk2p7";
        authors = [
      ...
      "metrics-exporter-prometheus" = rec {
        ...
        version = "0.17.2";
        edition = "2018";
        sha256 = "05cc7wqk7n01b19h63w03mslbmffxppk6j7i3i9y4gh0jvm6s5ib";
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            features = [ "recency" "registry" "storage" ];
          }
          {
            name = "quanta";
            packageId = "quanta";
      ...
      "metrics-process" = rec {
        crateName = "metrics-process";
        version = "2.4.1";
        edition = "2018";
        sha256 = "1gw3xn6ncdgm1ny6ydabzz3ibw7371jd5vcp2pq88ywb40cd36c4";
        libName = "metrics_process";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            ...
            target = { target, features }: ("windows" == target."os" or null);
            features = [ "Win32_Foundation" "Win32_System_Threading" "Win32_System_ProcessStatus" ];
          }
        ];
        features = {
          "default" = [ "metrics-rs" ];
        ...
        resolvedDefaultFeatures = [ "default" "metrics-rs" ];
      };
      "metrics-util" = rec {
        crateName = "metrics-util";
        version = "0.20.0";
        edition = "2018";
        sha256 = "11mrk9v4yjwqfs41hwx7r40ikxw4fyisy1drzwczkl0majhbg3gy";
        ...
        resolvedDefaultFeatures = [ "crossbeam-epoch" "crossbeam-utils" "hashbrown" "quanta" "rand" "rand_xoshiro" "recency" "registry" "sketches-ddsketch" "storage" ];
      };
      "mime" = rec {
        crateName = "mime";
        version = "0.3.17";
      ...
      "pkrs-fork" = rec {
        ...
        version = "0.4.0";
        edition = "2021";
        sha256 = "1syz3h044qzddj59m1a9v5ay26wwahml7am3iz2l78m3ams3gkhi";
        libName = "pkrs_fork";
        authors = [
          "z0w13"
          "lynxize"
        ...
        resolvedDefaultFeatures = [ "reqwest-client" "rustls-tls" ];
      };
      "portable-atomic" = rec {
      ...
      "procfs" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "17swyjqinpb745f07dpdi7c8q37hxvhx9xmmsi2dhxaj2kc74nyc";
        authors = [
      ...
      "procfs-core" = rec {
        ...
        version = "0.17.0";
        edition = "2018";
        sha256 = "1v0jdbyc1rq1x22m0wn7n4iq4h86gdls38wqfg06zc29hcnz1793";
        libName = "procfs_core";
        authors = [
          "Andrew Chin <achin@eminence32.net>"
        ];
      ...
      "reconnecting-amqp" = rec {
        crateName = "reconnecting-amqp";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./reconnecting-amqp; };
        libName = "reconnecting_amqp";
        dependencies = [
          {
            name = "amqprs";
            packageId = "amqprs";
            features = [ "compliance_assert" "traces" "urispec" ];
          }
          {
            name = "async-trait";
            packageId = "async-trait";
      ...
      "redis" = rec {
        ...
        resolvedDefaultFeatures = [ "aio" "bytes" "connection-manager" "tokio-comp" ];
      };
      "redox_syscall" = rec {
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "blocking" "charset" "h2" "http2" "json" "rustls-tls" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.13";
      ...
      "serde_either" = rec {
        crateName = "serde_either";
        version = "0.2.1";
        edition = "2018";
        sha256 = "1yzja6inn7jkjgarzzhz3589g1pmzmmidk6j4z9gqvw2wzs475k8";
        authors = [
          "Adilson Schmitt Junior <adilsonschj@gmail.com>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "sqlx" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "any" "chrono" "default" "derive" "json" "macros" "migrate" "postgres" "runtime-tokio" "sqlx-macros" "sqlx-postgres" ];
      };
      "sqlx-core" = rec {
        crateName = "sqlx-core";
        version = "0.8.6";
      ...
      "sqlx-macros" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "chrono" "default" "derive" "json" "macros" "migrate" "postgres" ];
      };
      "sqlx-macros-core" = rec {
        ...
        resolvedDefaultFeatures = [ "_rt-tokio" "chrono" "default" "derive" "json" "macros" "migrate" "postgres" "sqlx-postgres" "tokio" ];
      };
      "sqlx-mysql" = rec {
      ...
      "tachyonix" = rec {
        ...
        version = "0.2.1";
        edition = "2021";
        sha256 = "014n9k5w8k575snxlqb5hkby206vcmiisqpapzpxnn9kps1bzq34";
        authors = [
          "Serge Barral <serge.barral@asynchronics.com>"
        ];
        dependencies = [
          ...
          }
          {
            name = "loom";
            packageId = "loom";
            target = { target, features }: (target."tachyonix_loom" or false);
          }
        ];
      ...
      "tokio-websockets" = rec {
        ...
        version = "0.11.3";
        edition = "2021";
        sha256 = "0df4q4mjr51zjic5s9qk161aqa8s01i32l88vfjn7iijr2fnzi7v";
        ...
        resolvedDefaultFeatures = [ "client" "fastrand" "ring" "rustls-webpki-roots" "sha1_smol" "simd" ];
      };
      "tower" = rec {
        crateName = "tower";
        version = "0.5.2";
      ...
      "tulpje-cache" = rec {
        crateName = "tulpje-cache";
        version = "0.3.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./cache; };
        libName = "tulpje_cache";
        dependencies = [
          {
            name = "redis";
            packageId = "redis";
          ...
          }
          {
            ...
            packageId = "twilight-cache-inmemory";
          }
          {
            name = "twilight-model";
      ...
      "tulpje-framework" = rec {
        crateName = "tulpje-framework";
        version = "0.14.2";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./framework; };
        libName = "tulpje_framework";
        dependencies = [
          {
            name = "async-cron-scheduler";
            packageId = "async-cron-scheduler";
            features = [ "logging" ];
          }
          {
            name = "chrono";
          ...
          {
            name = "twilight-http";
            packageId = "twilight-http";
            usesDefaultFeatures = false;
            features = [ "decompression" "rustls-ring" "rustls-webpki-roots" ];
          }
          {
            name = "twilight-model";
            packageId = "twilight-model";
      ...
      "tulpje-gateway" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "figment_file_provider_adapter";
          }
          {
            name = "futures-util";
            packageId = "futures-util";
          ...
          }
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "rustls-tls" "charset" "http2" ];
          }
          {
            name = "serde";
            packageId = "serde";
          ...
          }
          {
            ...
            packageId = "twilight-gateway";
            usesDefaultFeatures = false;
            features = [ "rustls-ring" "rustls-webpki-roots" ];
          }
          {
            name = "twilight-model";
            packageId = "twilight-model";
      ...
      "tulpje-handler" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./handler; };
        dependencies = [
          {
            name = "base64";
            packageId = "base64";
          ...
          }
          {
            name = "sqlx";
            packageId = "sqlx";
            features = [ "runtime-tokio" "postgres" "chrono" "json" "macros" "migrate" ];
          }
          {
            name = "tokio";
            packageId = "tokio";
      ...
      "tulpje-manager" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./manager; };
        dependencies = [
          {
            name = "tokio";
            packageId = "tokio";
        ...
        dependencies = [
          {
            ...
            packageId = "reqwest";
            usesDefaultFeatures = false;
            features = [ "blocking" "charset" "h2" "http2" "rustls-tls" ];
          }
        ];

      };
      "twilight-cache-inmemory" = rec {
        crateName = "twilight-cache-inmemory";
        version = "0.16.0";
        edition = "2021";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/twilight-rs/twilight.git";
          rev = "7f08d954c7b4f4245047f34de5116abdb53f24d9";
          sha256 = "1ycvwwx8aq7yhq5j8dkmnjkmr0b8h1l2f3b8xmh2lhd1iz7kxjax";
        };
        libName = "twilight_cache_inmemory";
        authors = [
      ...
      "twilight-gateway" = rec {
        ...
        devDependencies = [
          {
            ...
            packageId = "tokio";
            usesDefaultFeatures = false;
            features = [ "macros" "rt-multi-thread" "signal" "test-util" ];
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "rustls-ring" "rustls-webpki-roots" ];
      };
      ...
      "twilight-http" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "hyper-util";
            usesDefaultFeatures = false;
            features = [ "client-legacy" "http1" "http2" "tokio" ];
          }
          {
            name = "percent-encoding";
            packageId = "percent-encoding";
          ...
          }
          {
            ...
            packageId = "twilight-http-ratelimiting";
            usesDefaultFeatures = false;
          }
          {
            name = "twilight-model";
        ...
        resolvedDefaultFeatures = [ "decompression" "rustls-ring" "rustls-webpki-roots" ];
      };
      "twilight-http-ratelimiting" = rec {
        crateName = "twilight-http-ratelimiting";
        version = "0.16.0";
        edition = "2021";
        workspace_member = null;
        src = pkgs.fetchgit {
        ...
        libName = "twilight_http_ratelimiting";
        authors = [
          "Twilight Contributors"
        ];
        dependencies = [
      ...
      "twilight-util" = rec {
        ...
        resolvedDefaultFeatures = [ "builder" ];
      };
      "twilight-validate" = rec {
        crateName = "twilight-validate";
        version = "0.16.0";
        edition = "2021";
        workspace_member = null;
        src = pkgs.fetchgit {
      ...
      "web-sys" = rec {
        ...
        resolvedDefaultFeatures = [ "AbortController" "AbortSignal" "Blob" "BlobPropertyBag" "Event" "EventTarget" "File" "FormData" "Headers" "MessageEvent" "Performance" "ReadableStream" "Request" "RequestCache" "RequestCredentials" "RequestInit" "RequestMode" "Response" "ServiceWorkerGlobalScope" "Window" "Worker" "WorkerGlobalScope" "default" "std" ];
      };
      "web-time" = rec {
        crateName = "web-time";
        version = "1.1.0";
      ...
      "windows 0.61.3" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_System" "Win32_System_ProcessStatus" "Win32_System_Threading" "default" "std" ];
      };
      ...
      "windows-sys 0.59.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_NetworkManagement" "Win32_NetworkManagement_IpHelper" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Com" "Win32_System_Diagnostics" "Win32_System_Diagnostics_Debug" "Win32_System_IO" "Win32_System_Pipes" "Win32_System_SystemServices" "Win32_System_Threading" "Win32_System_WindowsProgramming" "Win32_UI" "Win32_UI_Shell" "default" ];
      };
